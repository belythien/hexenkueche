            ...
            <div class="form-group row">
                @foreach(language()->allowed() as $code => $language)
                    <div class="col-md-6">
                        ...
                        {{Form::text('name[' . $code . ']', $event->translate($code)->name, ['class' => 'form-control'])}}
                    </div>
                @endforeach
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                @foreach(language()->allowed() as $code => $language)
                    <div class="col-xl-6">
                        ...
                        {{Form::textarea('description[' . $code . ']', $event->translate($code)->description, ['class' => 'text-ckeditor form-control'])}}
                    </div>
                @endforeach
            </div>
